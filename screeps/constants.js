global.HARVESTERS_DESIRED =        { 'Markopolis':   2, 'Stevenopolis': 2, 'Alanopolis':   2, 'Thomasopolis':   1, }
global.REMOTE_HARVESTERS_DESIRED = { 'Markopolis':   0, 'Stevenopolis': 0, }

global.BUILDERS_DESIRED =          { 'Markopolis':   1, 'Stevenopolis': 1, 'Alanopolis':   1, 'Thomasopolis':   1, }

global.UPGRADERS_DESIRED =         { 'Markopolis':   1, 'Stevenopolis': 1, 'Alanopolis':   1, 'Thomasopolis':   1, }
global.REMOTE_UPGRADERS_DESIRED =  { 'Markopolis':   0, 'Stevenopolis': 0, }
global.MEGA_UPGRADERS_DESIRED =    { 'Markopolis':   0, 'Stevenopolis': 1, 'Alanopolis':   1, }

global.DEFENDERS_DESIRED =         { 'Markopolis':   1, 'Stevenopolis': 1, 'Alanopolis':   1, }

global.MINERS_DESIRED =            { 'Markopolis':   0, 'Stevenopolis': 0, 'Alanopolis':   0, }

global.CLAIMERS_DESIRED =          { 'Markopolis':   0, 'Stevenopolis': 0, 'Alanopolis':   0, }
...
global.UPGRADERS_BODY = {
    ...
    'Alanopolis':   [WORK,WORK,WORK,WORK,WORK,WORK,WORK,CARRY,CARRY,CARRY,CARRY,CARRY,MOVE,MOVE,MOVE,MOVE,MOVE],
    'Thomasopolis': [WORK,CARRY,MOVE],
}
...
global.MEGA_UPGRADERS_BODY = {
    'Markopolis':   [WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,
...
global.CLAIMERS_BODY = {
    ...
    'Stevenopolis': [TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,
                     ...
                     CLAIM,
                     MOVE,MOVE,MOVE,MOVE,MOVE,MOVE],
    'Alanopolis':   [TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,TOUGH,
                     RANGED_ATTACK,
                     ATTACK,
                     HEAL,
                     CLAIM,
...
global.WALL_STRENGTH = {
    ...
    'Stevenopolis': WALL_HITS_MAX-168000,
    'Alanopolis':   WALL_HITS_MAX-102000,
    'thomasopolis': WALL_HITS_MAX-  1000,
}
global.WALL_BUILDER_STRENGTH = {
    'W44N1': WALL_HITS_MAX - 25000,
